...
let TL_PX = 1;                   // px per minute; rescaled per build to zoom the view window to fill the column
const TL_START = 4 * 60 + 30;    // 4:30am
const TL_END   = 28 * 60 + 30;   // 4:30am next day
const TL_H     = TL_END - TL_START; // 1440 (minutes; px = TL_H * TL_PX)
const TL_VIEW_MIN = 16 * 60;     // visible window: current hour + next 15; rest scrolls
const SNAP     = 15;
