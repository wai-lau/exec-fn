...
It undershoots, and that is the springs doing their job: **wide targets 1.60 and reaches 1.26, tall targets 0.50 and reaches 0.71** (at 325 iterations). Still worth it — a 0.49 phone picks the tall bake and `stretchToViewport` covers 0.72 -> 0.49 rather than 1.6 -> 0.49, roughly a third of the distortion. `_SHAPE_RATE` is the knob if it should push harder against the forces.
