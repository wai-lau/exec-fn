...
exec-fn/
  ...
  web/                    # static frontend (index.html, fonts, card-dialog.js, images)
    ...
    tts.js tts.css silence.wav  # /hosaka (HOSAKA) TTS page assets: tts.js drives the SPEAK UI (voice list, clone/playback knobs) on top of a HosakaAudio player (shared audio/WS/iOS core now lives in hosaka-audio.js). See routes_tts.py
  ...
  api/
    ...
    templates/            # volume-mounted → live on save
      ...
      tts.html            # /hosaka — HOSAKA SPEAK UI (h1 "HOSAKA" in Ono-Sendai green; textarea flex-grows to fill the column; voice select, clone/playback knobs); assets web/tts.{js,css}
