...
exec-fn/
  ...
  api/
    ...
    tarot/
      ...
      personas.py         # reader persona registry: PERSONAS{id,name,voice_id,backend,gain,brief,opener?}. `reader` (af_nicole) = default, brief None = single-pass/no restyle. `glados` (voice glados/piper) = GLaDOS voice brief + fixed opener. get_persona_brief/get_persona_opener/public_list (brief stripped — server-only)
