# Graph Report - exec-fn  (2026-06-13)

## Corpus Check
- 84 files · ~4,582,977 words
...
Cohesion: 0.20
Nodes (10): api_context_patch(), api_debug_logs(), _atomic_write_json(), _build_nav(), color_usage(), graph_page(), nightfall_page(), var(--X) occurrence counts + actually-used alphas per -hsl token +     per-(toke (+2 more)
