# Graph Report - exec-fn  (2026-06-18)

## Corpus Check
- 105 files · ~4,584,998 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 841 nodes · 1382 edges · 50 communities (38 shown, 12 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 191 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9da1bd69`
...
Cohesion: 0.07
Nodes (29): classify_card(), parse_date_natural(), Card-creation LLM helpers: classify a new card's category + importance, and pars, _build_context(), _entry_is_significant(), _entry_line(), flush_monitor(), generate_encouragement() (+21 more)
...
Cohesion: 0.24
Nodes (5): _card_summary(), _load_cards(), _load_rulings(), lookup_card(), lookup_rulings()

### Community 9 - "MTG Rules Assistant"
Cohesion: 0.08
Nodes (30): Scoped bearer auth for /api/exec/say. EXEC_SAY_KEY only grants message-queueing,, require_auth(), require_guest_auth(), require_say_auth(), _lifespan(), _no_cache_static(), Request, FastAPI entry point: app, lifespan, middleware, 401 redirects, wiring.  Routes l (+22 more)
...
Cohesion: 0.09
Nodes (40): _build_nav(), _index_pages(), Page composition: nav builder, index-shell variants, template loader.  Pure rend, Return (no_form, bare) variants of /app/static/index.html, re-read on change., _render_page(), _tmpl(), build_nightfall_html(), api_debug_logs() (+32 more)
...
- **Why does `api_morning()` connect `Google Calendar Sync` to `Community 0`, `MTG Rules Assistant`, `Exec Chat Tools`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `HTTPException` connect `MTG Rules Assistant` to `Community 0`, `Tarot Reader Engine`, `Community 34`, `Google Calendar Sync`?**
