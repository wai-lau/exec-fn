# Graph Report - exec-fn  (2026-06-16)

## Corpus Check
- 102 files · ~4,582,399 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 821 nodes · 1350 edges · 56 communities (46 shown, 10 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 186 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4448481c`
...
- `_landing_html()` --calls--> `_index_pages()`  [INFERRED]
  api/routes_views.py → api/pages.py
- `api_prophecies_patch()` --references--> `Request`  [EXTRACTED]
  api/routes_api.py → api/routes_views.py
...
Cohesion: 0.12
Nodes (12): api_context_patch(), api_prophecies_patch(), api_rd_patch(), _atomic_write_json(), _flag_triage(), _log_entries_for_patch(), _minutes_late(), JSON API routes: card CRUD, scheduling, profile/context, gcal, monitor + nudge c (+4 more)
...
Cohesion: 0.12
Nodes (18): api_debug_logs(), color_usage(), graph_page(), guest_login(), guest_login_alias(), login(), login_page(), HTML page routes + the read-only data GETs that back them.  Public landing/login (+10 more)
...
Cohesion: 0.19
Nodes (25): addMsg(), addStreamDiv(), armFirstGestureFocus(), bindNavButton(), buildPanel(), _caretOffset(), closePanel(), connectMonitorStream() (+17 more)
...
Cohesion: 0.07
Nodes (27): get_chat(), _lifespan(), _no_cache_static(), Request, FastAPI entry point: app, lifespan, middleware, 401 redirects, wiring.  Routes l, unauthorized_handler(), Path, The three top-level APIRouters, shared by every route module.  Defined here (not (+19 more)
...
Cohesion: 0.16
Nodes (10): _active_nudge_block(), _build_chat_system_prompt(), _dedupe_context(), _focused_nudge_card(), Most-recently-nudged card with an active nudge loop., get_rd_log(), _load_json(), _parse_json() (+2 more)
...
Cohesion: 0.07
Nodes (54): active_label(), active_anchor(), assign_auto_deadlines(), _back_schedule(), card_deadline(), compute_deadlines(), ensure_event_terminal(), _has_fixed_deadline() (+46 more)
...
Cohesion: 0.33
Nodes (9): _now_et(), clear_awaiting_focused(), User spoke in exec chat: mark the focused awaiting card replied-to so the     st, build_morning(), _morning_retrospective(), _purge_stale_notes(), Roll past-dated scheduled_day forward; auto-schedule rd cards due     within the, _roll_and_schedule() (+1 more)
...
Cohesion: 0.48
Nodes (6): build_morning(), _morning_retrospective(), _purge_stale_notes(), Roll past-dated scheduled_day forward; auto-schedule rd cards due     within the, _roll_and_schedule(), _run_step()
...
- **Why does `build_morning()` connect `Community 46` to `Community 34`, `Exec Chat Tools`, `Community 36`, `Community 42`, `Google Calendar Sync`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `api_morning()` connect `Community 34` to `Community 0`, `Community 46`, `Community 54`?**
