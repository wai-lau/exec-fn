...
## Corpus Check
- 744 files · ~9,808,416 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4089 nodes · 6105 edges · 535 communities (436 shown, 99 thin omitted)
...
## Communities (535 total, 99 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.12
Nodes (16): api_mtg_log(), guest_login_alias(), guest_login_page(), login(), login_page(), HTML page routes + the read-only data GETs that back them.  Public landing/login, Admin login screen. Already-authed visitors skip it and land on their     redire, Bookmark-safe alias for the renamed /guest route. (+8 more)
...
Cohesion: 0.14
Nodes (21): Request, BaseModel, api_tarot_chat(), api_tarot_draw(), api_tarot_save(), _build_spread_preamble(), _cap_messages(), ChatBody (+13 more)
...
Cohesion: 0.07
Nodes (20): AudioLoaderProps, AudioLoaderState, BattleIntro, BattleIntroProps, BattleIntroState, Button, ButtonColor, ButtonProps (+12 more)
...
Cohesion: 0.14
Nodes (13): fetch_mode(), Owner-only client for the home-box gpu-mode service (port 8124, reached over the, Current mode, or 'gone' if the home service / tunnel is unreachable., Run an action; return the resulting mode, or 'gone' on failure., switch_mode(), _current_mode(), gpu_mode_get(), _live() (+5 more)
...
Cohesion: 0.06
Nodes (22): Landing, LandingProps, LandingState, Loader, LoaderProps, LoaderState, NOOP_PLAYER, SaveFileName (+14 more)
...
Cohesion: 0.08
Nodes (16): ButtonBorder, DialogueProps, DialogueState, GuideTextProps, Hackerman, HackermanProps, HackermanState, HeaderBox() (+8 more)

### Community 112 - "Community 112"
Cohesion: 0.15
Nodes (25): ALL_WAREZ_PRICES, App, AppProps, AppState, CurrentUI, BattleProps, Netmap3DProps, NetmapEdgesProps (+17 more)
...
Cohesion: 0.11
Nodes (13): DatabattleConfig, Battle, IStaticMenuOptions, options, StaticMenuProps, StaticMenuType, ISelection, SelectionType (+5 more)
...
Cohesion: 0.20
Nodes (9): The three top-level APIRouters, shared by every route module.  Defined here (not, emet_ask(), emet_page(), emet_recall(), emet_scope(), Request, Owner-only /emet page + JSON routes wrapping Wai's "emet" knowledge-graph MCP., The /graph page — graphify's self-contained codebase viz, re-served.  graph.html (+1 more)
...
## Knowledge Gaps
- **1368 isolated node(s):** `dead-file-guard.sh script`, `deploy-healthcheck.sh script`, `docs-commit-guard.sh script`, `git-stash-guard.sh script`, `session-context.sh script` (+1363 more)
...
- **Why does `FastAPI` connect `Community 141` to `Community 128`, `Community 0`, `Community 5`, `Tarot Core Framework`, `Community 8`, `Community 108`, `Community 110`, `Community 79`, `Community 88`, `Community 59`, `Community 92`, `Community 31`?**
