...
def decompose_sync(card: dict, feedback: str = "") -> dict:
    system = (
        ...
        "matters, and ENDS on the question of whether it is done yet — two sentences at "
        "the outside, under 30 words. Name only that chunk — never reveal the whole plan.\n\n"
...
def nudge_text_sync(card: dict) -> str:
    ...
    system = (
        ...
        "whether it is done yet LAST. Two sentences at the outside, under 30 words. Speak "
        "about that chunk only — never reveal the whole plan.\n"
        f"{_TONE}\n"
        ...
        "future is 'done' reads as nonsense. It still ends on the question. Model: \"6:30, "
        "you leave to meet Aman — 30-minute trip. Ready to walk out?\" Keep the register "
