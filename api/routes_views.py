...
_GRAPH_OVERLAY_CSS = '<link rel="stylesheet" href="/graph-overlay.css?v=37">'
...
async def graph_page(request: Request):
    ...
    # /graphify). Guest-gated (Turnstile): the graph is just codebase structure; sensitive node
...
async def security_page(request: Request):
    # Guest-gated (Turnstile). Content is rendered from data/security.json, refreshed out-of-band by
