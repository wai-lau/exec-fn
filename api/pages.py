...
_CHROME_LINK = '<link rel="stylesheet" href="/chrome.css?v=78">'
...
def _nav_icon(name: str, alt: str) -> str:
    ...
    return f'<img src="/icons/{name}.svg?v=14" alt="{alt}" style="width:20px;height:20px;">'
...
def _build_nav(active=None, guest=False):
    ...
    script = (
        ...
        "_rf.innerHTML='<img src=\"/icons/firewall.svg?v=14\" alt=\"refresh\" "
