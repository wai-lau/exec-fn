...
_FAVICON = '<link rel="icon" type="image/png" href="/favicon.png?v=5">'
...
def _nav_icon(name: str, alt: str) -> str:
    ...
    return f'<img src="/icons/{name}.svg?v=5" alt="{alt}" style="width:20px;height:20px;">'
...
def _build_nav(active=None, guest=False):
    ...
    script = (
        ...
        "_rf.innerHTML='<img src=\"/icons/firewall.svg?v=5\" alt=\"refresh\" "
    ...
    if guest:
        ...
        bubble = ('<script src="/hosaka-audio.js?v=6"></script>'
                  ...
                  '<script src="/exec-bubble-drag.js?v=5"></script>'
                  '<script src="/exec-todos.js?v=5"></script>'
                  ...
                  '<script src="/exec-bubble.js?v=56"></script>')
    else:
