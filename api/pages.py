...
_CHROME_LINK = '<link rel="stylesheet" href="/chrome.css?v=58">'
...
_NAV_ICONS = {
    ...
    "ui":          '<img src="/data-doctor.png" alt="UI" style="width:20px;height:20px;image-rendering:pixelated;">',
...
def _build_nav(active=None, guest=False):
    ...
    if guest:
        ...
        bubble = ('<link rel="stylesheet" href="/exec-bubble.css?v=18">'
