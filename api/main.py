...
async def nightfall_page(request: Request):
    ...
    _nf_style = "<style>body,.App{background:#000!important;background-color:#000!important}html,body{height:100%!important}#root{height:calc(100% - 58px)!important}</style>"
