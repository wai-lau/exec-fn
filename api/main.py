...
from nudge_loop import _run_nudge_loop, _nudge_tick
from auth import (
...
def _build_nav(active=None, guest=False):
    ...
    bubble = ('<script src="/exec-bubble-drag.js?v=1"></script>'
              '<script src="/exec-bubble.js?v=29"></script>') if show_bubble else ''
...
_GRAPH_OVERLAY_JS = '<script src="/graph-overlay.js?v=31"></script>'
